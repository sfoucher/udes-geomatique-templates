\chapter{Revue de littérature et cadre théorique} \label{chap:cadretheorique}

Introduction et annonce du plan du chapitre.

\lipsum[1]

\section{Section 1} \label{sec:cadretheorique_1}

Paragraphe.
\lipsum[1] % génère un paragraphe (à supprimer)


\section{Section 2} \label{sec:cadretheorique_2}
