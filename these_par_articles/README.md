# Modèle Typst — Thèse par articles

Modèle **Typst** pour la rédaction d'une thèse de doctorat **par articles**
...
```
main.typ                    Point d'entrée (ordre des chapitres, parties I/II/III)
...
chapitres/                  Introduction, revue de littérature, méthodologie,
                             articles, discussion, conclusion, annexes
