...
\section{Titre de niveau 1} \label{sec:introduction-2}

\lipsum[1] % génère un paragraphe (à supprimer)

\section{Titre de niveau 1} \label{sec:introduction-3}
...
Comme discuté dans la section~\ref{sec:introduction-1}, ...

\subsection{Titre de niveau 2} \label{sec:introduction-3-1}

\lipsum[1] % génère un paragraphe (à supprimer)


\subsection{Titre de niveau 2} \label{sec:introduction-3-2}

\lipsum[1] % génère un paragraphe (à supprimer)


\subsection{Titre de niveau 2} \label{sec:introduction-3-3}

\lipsum[1] % génère un paragraphe (à supprimer)


\section{Titre de niveau 1} \label{sec:introduction-4}
